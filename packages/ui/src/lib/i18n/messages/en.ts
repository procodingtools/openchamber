...
export const dict = {
  ...
  'chat.chatInput.toast.messageSendFailed': 'Message failed to send. Your message and attachments have been restored.',
  'chat.chatInput.toast.messageSendMaybeFailed': 'Message may not have been sent. Your message has been preserved — review before retrying.',
  'chat.chatInput.toast.messageRestoredToInput': 'Your message has been restored to the input.',
