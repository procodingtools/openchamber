...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "chat.chatInput.toast.messageSendFailed": "A mensagem não pôde ser enviada. Sua mensagem e anexos foram restaurados.",
  "chat.chatInput.toast.messageSendMaybeFailed": "A mensagem pode não ter sido enviada. Sua mensagem foi preservada — revise antes de tentar novamente.",
  "chat.chatInput.toast.messageRestoredToInput": "Sua mensagem foi restaurada para o campo de entrada.",
